...
$cfg['db_user'] = 'sanjay';
$cfg['db_pass'] = 'p0ssw0rd@123';
$cfg['db_name'] = 'forma_lms';
$cfg['db_charset'] = 'utf8';
...
$cfg['use_smtp']            = 'on';
$cfg['smtp_host']           = 'smtp.gmail.com';			// Options: hostname;hostname:port;...
$cfg['smtp_port']           = '587';			// Options: '' (default port) , port number
$cfg['smtp_secure']         = 'tls';			// Options: "", "ssl", "tls"
$cfg['smtp_auto_tls']       = 'on';		// Options: true, false
$cfg['smtp_user']           = 'anetworks.test1@gmail.com';
$cfg['smtp_pwd']            = '1qaz2wsx3edc#@!';
